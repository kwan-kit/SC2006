...
class NoviceTrainingPlan extends TrainingPlan {
    constructor() {
        super('novice', 0.1); 
    }
    ...
    async createTrainingSchedule() {
        try {
            console.log('Starting schedule creation for novice plan...');
            ...
            for (let week = 0; week < this.trainingPeriod; week++) {
                ...
                for (let day = 0; day < 7; day++) {
                    ...
                    // Wednesday and Thursday: Medium Run
                    else if (day === 2 || day === 3) {
            ...
            console.error('Error creating novice training schedule:', error);
            throw error;
        }
    }
...
module.exports = NoviceTrainingPlan; //checkpoint2